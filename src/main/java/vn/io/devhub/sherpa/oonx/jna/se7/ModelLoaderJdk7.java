 ...
 */
public final class ModelLoaderJdk7 {
    ...
    public static synchronized File resolve() throws IOException {
        ...
        ClassLoader cl = ModelLoaderJdk7.class.getClassLoader();
    ...
    private static File resolveFromFilesystem() {
        ...
        try {
            String classResource = ModelLoaderJdk7.class.getName().replace('.', '/') + ".class";
            URL classUrl = ModelLoaderJdk7.class.getClassLoader().getResource(classResource);
