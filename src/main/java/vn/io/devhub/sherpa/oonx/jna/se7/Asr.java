...
public class Asr {
     ...
     */
    public Asr(AsrLib lib, File modelDir, int numThreads, String provider) {
        this.lib = lib;
        ...
        // Paraformer model: NULL cho zipformer (chi dung cho paraformer model)
        this.handle = lib.asr_create_explicit(
                encoder, decoder, joiner, tokens, null,
                numThreads, provider);
