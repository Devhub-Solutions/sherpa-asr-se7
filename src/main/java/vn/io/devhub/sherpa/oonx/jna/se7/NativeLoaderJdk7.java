...
public final class NativeLoaderJdk7 {
    ...
    public static synchronized File resolve() throws IOException {
        ...
        ClassLoader cl = NativeLoaderJdk7.class.getClassLoader();
    ...
    private static File resolveFromFilesystem(String resDir) {
        ...
        try {
            String classResource = NativeLoaderJdk7.class.getName().replace('.', '/') + ".class";
            URL classUrl = NativeLoaderJdk7.class.getClassLoader().getResource(classResource);
